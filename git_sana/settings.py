"""
Django settings for git_sana project.
...
SECRET_KEY = 'django-insecure-4ga2d&m4m%0t@y^5ce7nnl(zbt7fe29pq4e__#qx54tt^&gcf='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['f5ad-103-54-106-198.ngrok-free.app'] #Needs to be updated everytime ngrok is restarted
...
WSGI_APPLICATION = 'git_sana.wsgi.application'
